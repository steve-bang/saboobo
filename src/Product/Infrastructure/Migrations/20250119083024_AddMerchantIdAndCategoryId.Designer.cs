...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250119083024_AddMerchantIdAndCategoryId")]
    partial class AddMerchantIdAndCategoryId
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SaBooBo.Product.Domain.AggregatesModel.Product", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2025, 1, 19, 8, 30, 23, 699, DateTimeKind.Utc).AddTicks(6260))
                        .HasColumnOrder(6);
                    ...
                    b.OwnsMany("SaBooBo.Product.Domain.AggregatesModel.Topping", "Toppings", b1 =>
                        {
                            ...
                            b1.Property<DateTime>("CreatedDate")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("timestamp with time zone")
                                .HasDefaultValue(new DateTime(2025, 1, 19, 8, 30, 23, 719, DateTimeKind.Utc).AddTicks(3000));
